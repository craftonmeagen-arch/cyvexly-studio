        ...
        return scripts.map(s => {
          try {
            ...
            if (obj["@type"] === "BreadcrumbList") {
              return { type: "BreadcrumbList", trail: obj.itemListElement.map(i => ({ position: i.position, name: i.name, item: i.item })) };
            }
...
const routes = [
  "http://localhost:5173/services/business-websites",
  "http://localhost:5173/work/aurora-spaces",
