...
**Chunk 10 candidate source:** `c8bc73d` (horizontal Work rail)

**Active review source:** `c8bc73d`
...
Owner direction `2026-09-10-02` now reopens the primary Work surface. The
current coherent slice replaces the fixed two-column collection with a
horizontal rail through the same four approved projects while preserving
their accepted proof hierarchy and truth boundaries. Required acceptance
covers visible controls, native touch/swipe, Arrow-key operation, end states,
reduced motion, working links, and zero page-level overflow across responsive
viewports. Accepted source remains `ca2b84e` while candidate `c8bc73d` moves
through two independent exact-source reviews.
...
Candidate `c8bc73d` replaces the fixed grid with a native overflow/scroll-snap
