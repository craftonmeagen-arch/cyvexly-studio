...
$caps = [ordered]@{
    ...
    # Current launch, search, local-service, and showcase directives remain live authority.
    'docs/agent-system/cyvexly/CYVEXLY_OWNER_DIRECTION.md' = 61440
    ...
    'docs/agent-system/cyvexly/CYVEXLY_TOOLS_AND_CAPABILITIES.md' = 28672
    'docs/agent-system/cyvexly/CYVEXLY_CURRENT_STATE.md' = 16384
    'docs/agent-system/cyvexly/CYVEXLY_PROJECT_CHUNK_MAP.md' = 20480
    'docs/agent-system/cyvexly/CYVEXLY_BUILD_SUMMARY.md' = 40960
    ...
    'docs/agent-system/cyvexly/CYVEXLY_REVIEW_INDEX.md' = 16384
