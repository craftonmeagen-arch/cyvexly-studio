...
export const selectedWork = [
  ...
  },
  {
    ...
    summary:
      "Teacher workspace connecting lesson planning, classroom activities, reading support, assignments, and special-education documentation.",
    tags: ["Education SaaS", "Role-aware workflows"],
    capabilities: [
      "One connected plan, teach, check, and document journey",
      "Multiple classroom formats from a teacher-reviewed lesson",
      "BloomED priorities, evidence, services, and reporting",
    ],
    href: "/work/eduailenz",
  ...
  },
  {
    ...
    summary:
      "Browser party-game platform with three distinct games and clear host, player, shared-screen, and account experiences.",
    tags: ["Real-time systems", "Multi-surface UX"],
    capabilities: [
      "Pass-the-phone and room-based play models",
      "Clear host, player, and shared-display roles",
      "Account-free public previews and guest entry paths",
    ],
    href: "/work/mudoinkle",
...
export const caseStudies = {
  ...
  eduailenz: {
    ...
    externalLabel: "Open the public product",
    externalNote:
      "The public product page is available without an account. Protected educator workflows still require sign-in.",
    proofChecked: "Source and public-route intake checked September 9, 2026",
    verifiedCapabilities: [
      "Lesson planning, saved work, assignments, reading, and classroom-activity areas",
      "BloomED caseload, goals, evidence, tasks, calendar, family, and reporting areas",
      "Protected educator spaces plus public lesson, player, and display routes",
      "Database-backed deployment with migration and readiness safeguards",
    ],
    proofPending: [
      "Full signed-in acceptance of provider connections and saved changes",
      "Complete reconnect, grading, import, reporting, and narration checks",
      "Restoration and fresh verification of the custom domain",
    ],
    inquiryHref: "/contact?interest=education-platform",
  ...
  mudoinkle: {
    ...
    externalLabel: "Open the public staging preview",
    externalNote:
      "This is a public staging build, not a production-launch claim. Final multi-role acceptance remains in progress.",
    proofChecked: "Source and public-route intake checked September 9, 2026",
    verifiedCapabilities: [
      "Three distinct game models with dedicated entry points",
      "Public join and display routes plus protected host and account areas",
      "Separate durable account data and fast-changing room state in the deployment design",
      "Health, safety, privacy, accessibility, and reporting routes",
    ],
    proofPending: [
      "Full multi-device room, reconnect, moderation, and recovery acceptance",
      "End-to-end List Off host, player, and display acceptance",
      "Production launch and final physical-device verification",
    ],
    inquiryHref: "/contact?interest=party-game-platform",
    plannerHref: "/start?service=custom-web-applications",
  },
};
