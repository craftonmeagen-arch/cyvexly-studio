    ...
    <main id="main-content" className="flex-1">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 sm:py-20">
        ...
        <div className="mt-7 space-y-7 text-sm leading-relaxed text-cool-graphite">
          <div><h3 className="font-semibold text-midnight-slate">What does a website cost?</h3><p className="mt-2">A tightly scoped $199 one-page Launch Offer is available to eligible new clients; standard custom website packages start at $1,800. The final price depends on scope, and your city does not turn a starting point into a fixed quote. <Link className="font-semibold text-cyber-blue underline" href="/pricing">Review published pricing</Link> and the <Link className="font-semibold text-cyber-blue underline" href="/resources/small-business-website-cost">website cost guide</Link>.</p></div>
