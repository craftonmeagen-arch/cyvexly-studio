...
assert.match(eduailenzCase, /Plan the lesson, record the evidence, review the progress\./);
assert.match(eduailenzCase, /Capability demonstrated:/);
assert.match(eduailenzCase, /Inspect desktop proof/);
assert.match(eduailenzCase, /Inspect phone proof/);
assert.match(eduailenzCase, /Live public product page(?:<!-- -->)? · desktop \+ phone/);
assert.match(eduailenzCase, /Accepted authenticated validation · no student data/);
assert.match(eduailenzCase, /Accepted authenticated validation · synthetic test account/);
...
assert.match(eduailenzCase, /\/media\/eduailenz-proof-quick-lesson\.png/);
assert.match(eduailenzCase, /\/media\/eduailenz-proof-progress-log-mobile\.png/);
assert.match(eduailenzCase, /\/media\/eduailenz-proof-reports\.png/);
assert.doesNotMatch(eduailenzCase, /Public guided-tour illustration/);
...
assert.match(mudoinkleCase, /Compare the prompt, pass-the-phone, and rapid-fire loops\./);
assert.match(mudoinkleCase, /complete multi-device room acceptance is still pending/i);
assert.match(mudoinkleCase, /Capability demonstrated:/);
assert.match(mudoinkleCase, /Inspect desktop proof/);
assert.match(mudoinkleCase, /Inspect phone proof/);
...
assert.match(mudoinkleCase, /\/media\/mudoinkle-proof-awmuhog\.png/);
assert.match(mudoinkleCase, /\/media\/mudoinkle-proof-witigglies-mobile\.png/);
assert.match(mudoinkleCase, /\/media\/mudoinkle-proof-list-off\.png/);
assert.doesNotMatch(mudoinkleCase, /Public staging product tour|Public staging game catalog/);
